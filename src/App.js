...
var musicDB = {
  romantic: [
    { name: "Tera Ban Jaunga", rating: "4/5" },
    { name: "Kaise Mujhe Tum Mil Gayi", rating: "5/5" },
    { name: "Main Hoon Na", rating: "5/5" }
  ],
  electronic: [
    { name: "Bomb a Drop", rating: "5/5" },
    { name: "Speakerbox", rating: "5/5" },
    { name: "Lean On", rating: "5/5" }
  ],
  hiphop: [
    { name: "God's Plan", rating: "4/5" },
    { name: "Rap God", rating: "5/5" },
    { name: "Goodbyes", rating: "4.5/5" }
  ]
};
